...
const ICON_MAP = {
  ...
  '📯': '<image href="data:image/png;base64," x="0" y="0" width="16" height="16"/>',
...
function syncHUD(){
  ...
  if(titleEl){
    ...
    titleEl.textContent = wounded ? '🧸 BLOODIED · '+title : title;
  ...
  if(diff <= mode.perfect){
    ...
    if(hasPending){
      ...
      if(S.chugMisses >= 3 && !S.bloodied){
        ...
        toast('🧸 3 MISSES IN A ROW — BLOODIED! -30% XP until a perfect chug');
      }
    }
  }
...
function renderShop(){
  ...
  function itemCard(r, type, isExclusive){
    ...
    if(type==='relic' && owned){
      ...
      actionHtml = `<button class="btn ${cls} sm" style="width:auto;margin:0;padding:6px 10px" onclick="${fn}" ${afford?'':'disabled'}>${r.price} <span style="opacity:0.6;font-size:7px">COINS</span></button>`;
    }
